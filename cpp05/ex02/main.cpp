...
int main(void)
{
    ...
    Bureaucrat b1a = Bureaucrat("b1a", 145);
    Bureaucrat b1b = Bureaucrat("b1b", 137);
    ...
    Bureaucrat b2a = Bureaucrat("b2a", 145);
    Bureaucrat b2b = Bureaucrat("b2b", 137);
    ...
    Bureaucrat b3a = Bureaucrat("b3a", 145);
    Bureaucrat b3b = Bureaucrat("b3b", 138);
    ...
    {   
        ppf3->execute(b3b);
        std::cout << YELLOW << "Executed." << std::endl << std::endl;
    }
    ...
    Bureaucrat b4a = Bureaucrat("b4a", 72);
    Bureaucrat b4b = Bureaucrat("b4b", 45);
    ...
    Bureaucrat b5a = Bureaucrat("b5a", 72);
    Bureaucrat b5b = Bureaucrat("b5b", 45);
    ...
    Bureaucrat b6a = Bureaucrat("b6a", 72);
    Bureaucrat b6b = Bureaucrat("b6b", 46);
    ...
    Bureaucrat b7b = Bureaucrat("b7b", 5);
    ...
    Bureaucrat b8b = Bureaucrat("b8b", 5);
