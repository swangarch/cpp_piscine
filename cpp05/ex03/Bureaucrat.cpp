...
void        Bureaucrat::executeForm(AForm const& form) const
{
    ...
    {
        form.execute(*this);
        std::cout << YELLOW << this->_name << " executed " << form.getName() << COLOR_END << std::endl;
    }
    catch (std::exception& e)
    {
        std::cout << RED << this->_name << " couldn't execute " << form.getName() << " because " << e.what() << COLOR_END << std::endl;
    }
}
